...
// Accounts.
export type NewVaultInstructionAccounts = {
  vault?: PublicKey | Pda;
...
// Data.
export type NewVaultInstructionData = { discriminator: Uint8Array };

export type NewVaultInstructionDataArgs = {};

export function getNewVaultInstructionDataSerializer(): Serializer<
...
> {
  return mapSerializer<
    ...
    NewVaultInstructionData
  >(
    struct<NewVaultInstructionData>([['discriminator', bytes({ size: 8 })]], {
      description: 'NewVaultInstructionData',
    }),
    (value) => ({
      ...value,
      discriminator: new Uint8Array([0, 196, 119, 39, 154, 60, 10, 44]),
    })
  ) as Serializer<NewVaultInstructionDataArgs, NewVaultInstructionData>;
}

// Instruction.
export function newVault(
  context: Pick<Context, 'eddsa' | 'payer' | 'programs'>,
  input: NewVaultInstructionAccounts
): TransactionBuilder {
  // Program ID.
  ...
  // Data.
  const data = getNewVaultInstructionDataSerializer().serialize({});
